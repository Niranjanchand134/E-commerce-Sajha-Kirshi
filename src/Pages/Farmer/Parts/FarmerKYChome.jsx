...
const FarmerKYChome = () => {
    ...
    return(
        ...
        <div className="flex justify-center p-8">
            <p className="text-center max-w-3xl">To enjoy more of the wide range of services from Sajha Sewa, it is mandatory for all the customers 
            to fill the KYC (Know Your Customer) form to Buy and Sell Vegetables</p>
        </div>
